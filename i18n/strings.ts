...
export const translations = {
  ru: {
    ...
    settings: {
      ...
      dailyGoalSubtitle1:
        "Безопасного уровня потребления алкоголя не существует (ВОЗ). Чем меньше, тем лучше.",
      ...
      importReadFileError:
        "Не удалось прочитать файл. Попробуйте вставить данные вручную.",
    ...
    premium: {
      ...
      notConfigured:
        "Продукт не настроен в Google Play. Пожалуйста, обратитесь к разработчику.",
      notAvailable:
        "Покупки недоступны. Убедитесь, что приложение установлено из Google Play.",
      activeBody:
      ...
      features: {
        ...
        advancedStatsDesc:
          "Графики трендов, сравнение периодов, детальная аналитика",
        streakGoalTitle: "Цель по серии",
        streakGoalDesc:
          "Задайте цель (7, 30, 90 дней без алкоголя) и отслеживайте прогресс в статистике",
        ...
        calendarLabelsDesc:
          "Свои заметки к дням: отпуск, праздник, поездка — для контекста в статистике",
      },
    },
    drinkTypes: {
      beer: "Пиво",
    ...
    calendar: {
      ...
      labelsHint:
        "Период от и до включительно. Один день — выберите одинаковые даты.",
      allLabels: "Все метки",
      from: "От",
      to: "До",
      label: "Метка",
    ...
    onboarding: {
      ...
      tooltips: {
        welcome:
          "Добро пожаловать в DrinkNote! Покажем самое важное за несколько шагов.",
        favorites:
      ...
      slides: {
        helloTitle: "Привет!",
        helloDesc:
          "Рады видеть вас. Сейчас коротко покажем, как пользоваться приложением.",
        welcomeTitle: "Добро пожаловать в DrinkNote",
        welcomeDesc:
          "Удобный учёт алкоголя: избранное, календарь, статистика и цели. Коротко покажем основы.",
    ...
    statsScreen: {
      standardUnits: "Стандартных единиц",
      volume: "Объем",
      byDrinkTypes: "По типам напитков",
      byWeekdaysAvg: "По дням недели (среднее)",
      records: "Рекорды",
      heaviestDay: "Самый тяжелый день",
      alcoholFreeDays: "Дней без алкоголя",
      currentStreak: "Текущая серия",
      bestStreak: "Рекордная серия",
      goal: "Цель: {{days}}",
      goalAchieved: "Цель достигнута!",
      top5Drinks: "Топ-5 напитков",
      premiumShort: "Премиум",
      unlockPremium: "Разблокировать Премиум",
      tabBasic: "Базовая",
      tabAdvanced: "Расширенная",
      periodOverall: "Общая",
      periodWeek: "Неделя",
      periodMonth: "Месяц",
      baseLimitHint:
    ...
    presetNames: {
      ...
      negroni: "Негрони",
      oldFashioned: "Олд Фешн",
      whiskeySour: "Виски Сауэр",
      ginTonic: "Джин-тоник",
      aperolSpritz: "Апероль Шприц",
      bellini: "Беллини",
      sexOnTheBeach: "Секс на пляже",
      manhattan: "Манхэттен",
      whiskeyCola: "Виски Кола",
      rumCola: "Ром Кола",
    },
    widgets: {
      favoritesTitle: "ИЗБРАННОЕ",
  ...
  en: {
    ...
    settings: {
      ...
      dailyGoalSubtitle1:
        "There is no safe level of alcohol consumption (WHO). Less is better.",
      ...
      importHint:
        "Choose a file (.json or .txt) or paste JSON from an exported file",
      ...
      clearDataBody:
        "This can’t be undone. All entries, presets, and settings will be removed.",
      clearedTitle: "Done",
      ...
      importReadFileError:
        "Could not read the file. Try pasting the data manually.",
    ...
    premium: {
      ...
      notConfigured:
        "Product is not configured in Google Play. Please contact the developer.",
      notAvailable:
        "Purchases are unavailable. Make sure the app is installed from Google Play.",
      ...
      features: {
        ...
        advancedStatsDesc:
          "Trend charts, period comparisons, detailed analytics",
        streakGoalTitle: "Streak goal",
        streakGoalDesc:
          "Set a goal (7, 30, 90 days) and track your progress in stats",
        themesTitle: "Themes",
        ...
        calendarLabelsDesc:
          "Add notes to days (trip, holiday, etc.) for better context in stats",
      },
    },
    drinkTypes: {
      beer: "Beer",
    ...
    calendar: {
      ...
      labelsHint:
        "The period is inclusive. For a single day, pick the same dates.",
    ...
    oneTimeEntry: {
      ...
      subtitle:
        "A drink without adding it to Favorites — for example, a cocktail at a bar",
      name: "Name",
      type: "Type",
    },
    onboarding: {
      ...
      tooltips: {
        welcome:
          "Welcome to DrinkNote! We’ll show the essentials in a few steps.",
        favorites:
      ...
      slides: {
        ...
        welcomeDesc:
          "Track your drinks with favorites, calendar, stats, and goals. Here are the basics.",
        ...
        editDesc:
          "Long-press a favorite or a day entry to see actions: edit or delete.",
      },
    },
    stats: {
    ...
    statsScreen: {
      ...
      volume: "Volume",
      byDrinkTypes: "By drink type",
      byWeekdaysAvg: "By weekday (avg)",
      records: "Records",
      ...
      periodWeek: "Week",
      periodMonth: "Month",
      baseLimitHint: "Basic version shows stats for the last 3 months only",
    },
    currency: {
      RUB: "Russian ruble (₽)",
