...
export const translations = {
  ru: {
    ...
    calendar: {
      ...
      labelsHint: 'Период от и до включительно. Один день — выберите одинаковые даты.',
      allLabels: 'Все метки',
      from: 'От',
      to: 'До',
      label: 'Метка',
    ...
    statsScreen: {
      ...
      periodWeek: 'Неделя',
      periodMonth: 'Месяц',
      baseLimitHint: 'Базовая версия показывает статистику только за последние 3 месяца',
    },
    currency: {
  ...
  en: {
    ...
    calendar: {
      ...
      labelsHint: 'The period is inclusive. For a single day, pick the same dates.',
