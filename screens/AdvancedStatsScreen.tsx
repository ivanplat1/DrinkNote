...
import { WEEKDAY_LONG_EN, WEEKDAY_LONG_RU } from "../utils/date";
import {
  getMonthlyTrend,
  getWeeklyTrend,
          ...
          >
            <Text
              style={[
                ...
                {
                  color:
                    trendPeriod === "months" ? "#fff" : colors.textSecondary,
                },
              ]}
            >
          ...
          >
            <Text
              style={[
                ...
                {
                  color:
                    trendPeriod === "weeks" ? "#fff" : colors.textSecondary,
                },
              ]}
            >
                  ...
                  <View style={styles.streakInfo}>
                    ...
                    >
                      {new Date(streak.streakStart).toLocaleDateString(
                        t("widgets.mlShort") === "мл" ? "ru-RU" : "en-US",
                      )}{" "}
                      -{" "}
