...
export const highContrastTheme: ThemeColors = {
  ...
  // Типы напитков - профессиональные оттенки
  beer: {
    main: '#d97706', // Янтарный (amber-600)
    light: '#fef3c7', // Светло-янтарный фон (amber-100)
    text: '#92400e', // Темно-янтарный текст (amber-800)
  },
  wine: {
    main: '#7c3aed', // Фиолетовый (violet-600)
    light: '#ede9fe', // Светло-фиолетовый фон (violet-100)
    text: '#5b21b6', // Темно-фиолетовый текст (violet-800)
  },
  spirit: {
    main: '#dc2626', // Красный (red-600)
    light: '#fee2e2', // Светло-красный фон (red-100)
    text: '#991b1b', // Темно-красный текст (red-800)
  },
  cocktail: {
    main: '#0891b2', // Циан (cyan-600)
    light: '#cffafe', // Светло-циановый фон (cyan-100)
    text: '#0e7490', // Темно-циановый текст (cyan-800)
  },
  other: {
    main: '#64748b', // Серо-синий (slate-500)
    light: '#f1f5f9', // Светло-серо-синий фон (slate-100)
    text: '#475569', // Темно-серо-синий текст (slate-600)
  },
};
