...
const INTERACTIVE_STEPS: InteractiveStepConfig[] = [
  ...
  {
    key: 'addButton',
    tooltip: 'Кнопка «плюс» добавляет новые напитки в избранное. Нажмите, откроется список: можно выбрать готовый вариант или добавить свой.',
  },
  {
    key: 'oneTimeEntry',
    tooltip: 'Разовая запись — напиток без добавления в избранное. Удобно в баре или в гостях: укажите название, объём, крепость и при желании цену.',
  },
  {
    key: 'calendar',
