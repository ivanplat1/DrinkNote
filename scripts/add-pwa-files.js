  ...
  (function() {
    ...
    window.fetch = function(...args) {
      if (typeof args[0] === 'string') {
        args[0] = args[0].replace(/^https:\\/\\/ivanplat1\\.github\\.io\\/assets\\//, 'https://ivanplat1.github.io/DrinkNote/_expo/static/');
        args[0] = args[0].replace(/^\\/assets\\//, '/DrinkNote/_expo/static/');
      }
      return originalFetch.apply(this, args);
    };
    
    // Перехватываем создание элементов для исправления путей
      ...
      if (tagName === 'link' || tagName === 'script' || tagName === 'img') {
        ...
        element.setAttribute = function(name, value) {
          if ((name === 'href' || name === 'src') && typeof value === 'string') {
            value = value.replace(/^https:\\/\\/ivanplat1\\.github\\.io\\/assets\\//, 'https://ivanplat1.github.io/DrinkNote/_expo/static/');
            value = value.replace(/^\\/assets\\//, '/DrinkNote/_expo/static/');
          }
