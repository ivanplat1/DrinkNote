    ...
    <style>
      ...
      @media (display-mode: standalone) {
        ...
        div[style*="bottom:0px"] {
          ...
          /* Увеличиваем базовую высоту с 49px до 60px для лучшего размещения текста */
      ...
      function applyPadding(element) {
        ...
        if (isAtBottom || hasNavContent) {
          ...
          if (isStandalone) {
            ...
            // Используем базовую высоту 60px вместо 49px для лучшего размещения текста
            const currentMinHeight = style.minHeight || '60px';
            let currentMinHeightValue = parseInt(currentMinHeight) || 60;
            // Если текущая высота меньше 60px, увеличиваем до 60px
            if (currentMinHeightValue < 60) {
              currentMinHeightValue = 60;
            }
            ...
            if (style.height && style.height !== 'auto') {
              ...
              // Если текущая высота меньше 60px, увеличиваем до 60px
              if (currentHeightValue < 60) {
                currentHeightValue = 60;
              }
            ...
            Array.from(element.children).forEach(child => {
              ...
              const childMinHeight = childStyle.minHeight || '60px';
              let childMinHeightValue = parseInt(childMinHeight) || 60;
              if (childMinHeightValue < 60) {
                childMinHeightValue = 60;
              }
